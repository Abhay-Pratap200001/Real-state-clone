...
const UpdateListing = () => {
  ...
  // For adding loading effect in button 
  ...
  //fetch all listing data to keep into input filed so user can update     
  useEffect(() => {
  ...
  // HANDLE FORM SUBMISSION (Updating Listing)
  // -----------------------------------------
  ...
  return (
    <main className="p-3 max-w-4xl mx-auto">
      ...
      {/* == MAIN FORM START === */}
      <form onSubmit={handleUpdating} className="flex flex-col sm:flex-row gap-4">
